export const dict = {
  ...
  "dialog.project.provider.local.description": "Otwórz lokalny katalog",
  "dialog.project.provider.github.description": "GitHub ({{type}})",
  "dialog.project.provider.add.name": "Dodaj dostawcę",
  "dialog.project.provider.add.description": "Podłącz nowego dostawcę",
  "dialog.project.delete.title": "Usuń dostawcę",
  "dialog.project.delete.description": "Czy na pewno chcesz usunąć \"{{name}}\"? Spowoduje to usunięcie tokenu dostępu GitHub z Twojego komputera.",
  "dialog.project.delete.success.title": "Dostawca usunięty",
  "dialog.project.delete.success.description": "\"{{name}}\" został usunięty.",
  "dialog.project.delete.error.title": "Błąd podczas usuwania dostawcy",
  "dialog.project.open.title": "Otwórz projekt",
  "dialog.project.open.description": "Wybierz sposób otwarcia projektu",
  "dialog.project.search.placeholder": "Szukaj dostawców",
  "dialog.project.empty": "Brak dostępnych dostawców",
  "dialog.project.select_provider.title": "Wybierz dostawcę",
  "dialog.project.select_provider.description": "Wybierz dostawcę do podłączenia",
  ...
  "dialog.project.add_github.error.name_required": "Nazwa jest wymagana",
  "dialog.project.add_github.error.token_required": "Token jest wymagany",
  "dialog.project.add_github.error.invalid_token": "Wystąpił błąd z podanym tokenem. Ten token może już być nieważny",
  "dialog.project.add_github.success.title": "Klucz GitHub dodany",
  "dialog.project.add_github.success.description": "Możesz teraz używać tego klucza do dostępu do swoich repozytoriów GitHub.",
  "dialog.project.add_github.create_token": "Utwórz token na GitHub",
  "dialog.project.add_github.token_instruction": "Dla klasycznych tokenów użyj zakresu repo. Dla tokenów o ziarnistości dostępie przyznaj dostęp do repozytorium.",
  "dialog.project.add_github.name.label": "Nazwa",
  "dialog.project.add_github.name.placeholder": "Mój Token GitHub",
  "dialog.project.add_github.token.label": "Osobisty Token Dostępu",
  "dialog.project.add_github.token.placeholder": "ghp_xxxxxxxxxxxxxxxxxxxx",
  "dialog.project.add_github.button.add": "Dodaj klucz",
  "dialog.project.add_github.button.adding": "Dodawanie...",
  ...
  "dialog.project.clone.branch": "Gałąź: {{branch}}",
  ...
  "dialog.project.select_branch.empty": "Nie znaleziono gałęzi",
  "dialog.project.select_branch.back": "Powrót do repozytoriów",
  "dialog.project.select_branch.default": "Użyj gałęzi domyślnej ({{branch}})",
  ...
  "home.empty.description": "Otwórz lokalny projekt lub podłącz obsługiwanego dostawcę, aby zacząć",
