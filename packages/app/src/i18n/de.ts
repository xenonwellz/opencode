...
export const dict = {
  ...
  "dialog.project.provider.local.description": "Ein lokales Verzeichnis öffnen",
  "dialog.project.provider.github.description": "GitHub ({{type}})",
  "dialog.project.provider.add.name": "Anbieter hinzufügen",
  "dialog.project.provider.add.description": "Einen neuen Anbieter verbinden",
  "dialog.project.delete.title": "Anbieter löschen",
  "dialog.project.delete.description": "Sind Sie sicher, dass Sie \"{{name}}\" löschen möchten? Dies entfernt den GitHub-Zugriffstoken von Ihrem Computer.",
  "dialog.project.delete.success.title": "Anbieter gelöscht",
  "dialog.project.delete.success.description": "\"{{name}}\" wurde entfernt.",
  "dialog.project.delete.error.title": "Fehler beim Löschen des Anbieters",
  "dialog.project.open.title": "Projekt öffnen",
  "dialog.project.open.description": "Wählen Sie, wie Sie Ihr Projekt öffnen möchten",
  "dialog.project.search.placeholder": "Anbieter suchen",
  "dialog.project.empty": "Keine Anbieter verfügbar",
  "dialog.project.select_provider.title": "Anbieter auswählen",
  "dialog.project.select_provider.description": "Wählen Sie einen Anbieter zum Verbinden",
  ...
  "dialog.project.add_github.error.name_required": "Name ist erforderlich",
  "dialog.project.add_github.error.token_required": "Token ist erforderlich",
  "dialog.project.add_github.error.invalid_token": "Es gab einen Fehler mit dem bereitgestellten Token. Dieser Token ist möglicherweise nicht mehr gültig",
  "dialog.project.add_github.success.title": "GitHub-Schlüssel hinzugefügt",
  "dialog.project.add_github.success.description": "Sie können diesen Schlüssel jetzt verwenden, um auf Ihre GitHub-Repositorys zuzugreifen.",
  "dialog.project.add_github.create_token": "Token auf GitHub erstellen",
  "dialog.project.add_github.token_instruction": "Verwenden Sie für klassische Tokens den Repo-Scope. Für fein abgestimmte Tokens gewähren Sie Repository-Zugriff.",
  "dialog.project.add_github.name.label": "Name",
  "dialog.project.add_github.name.placeholder": "Mein GitHub-Token",
  ...
  "dialog.project.add_github.button.add": "Schlüssel hinzufügen",
  "dialog.project.add_github.button.adding": "Hinzufügen...",
  ...
  "dialog.project.select_branch.empty": "Keine Branches gefunden",
  "dialog.project.select_branch.back": "Zurück zu Repositorys",
  "dialog.project.select_branch.default": "Standard-Branch verwenden ({{branch}})",
