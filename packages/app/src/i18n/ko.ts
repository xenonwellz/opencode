...
export const dict = {
  ...
  "dialog.project.provider.local.name": "로컬",
  "dialog.project.provider.local.description": "로컬 디렉토리 열기",
  "dialog.project.provider.github.description": "GitHub ({{type}})",
  "dialog.project.provider.add.name": "공급자 추가",
  "dialog.project.provider.add.description": "새 공급자 연결",
  "dialog.project.delete.title": "공급자 삭제",
  "dialog.project.delete.description": "\"{{name}}\"을(를) 삭제하시겠습니까? 이 작업은 머신에서 GitHub 액세스 토큰을 제거합니다.",
  "dialog.project.delete.success.title": "공급자 삭제됨",
  "dialog.project.delete.success.description": "\"{{name}}\"이(가) 제거되었습니다.",
  "dialog.project.delete.error.title": "공급자 삭제 실패",
  "dialog.project.open.title": "프로젝트 열기",
  "dialog.project.open.description": "프로젝트를 여는 방법 선택",
  "dialog.project.search.placeholder": "공급자 검색",
  "dialog.project.empty": "사용 가능한 공급자가 없습니다",
  "dialog.project.select_provider.title": "공급자 선택",
  "dialog.project.select_provider.description": "연결할 공급자 선택",
  "dialog.project.add_github.title": "GitHub 키 추가",
  "dialog.project.add_github.description": "이 키의 이름과 GitHub 개인 액세스 토큰을 입력하십시오. 토큰은 머신에 안전하게 저장됩니다.",
  "dialog.project.add_github.error.name_required": "이름이 필요합니다",
  "dialog.project.add_github.error.token_required": "토큰이 필요합니다",
  "dialog.project.add_github.error.invalid_token": "제공된 토큰에 오류가 있습니다. 이 토큰은 더 이상 유효하지 않을 수 있습니다.",
  "dialog.project.add_github.success.title": "GitHub 키 추가됨",
  "dialog.project.add_github.success.description": "이제 이 키를 사용하여 GitHub 리포지토리에 액세스할 수 있습니다.",
  "dialog.project.add_github.create_token": "GitHub에서 토큰 생성",
  "dialog.project.add_github.token_instruction": "클래식 토큰의 경우 repo 권한을 사용하십시오. 파인 그레인드 토큰의 경우 리포지토리 액세스 권한을 부여하십시오.",
  "dialog.project.add_github.name.label": "이름",
  "dialog.project.add_github.name.placeholder": "내 GitHub 토큰",
  "dialog.project.add_github.token.label": "개인 액세스 토큰",
  "dialog.project.add_github.token.placeholder": "ghp_xxxxxxxxxxxxxxxxxxxx",
  "dialog.project.add_github.button.add": "키 추가",
  "dialog.project.add_github.button.adding": "추가 중...",
  "dialog.project.select_repo.title": "리포지토리 선택",
  "dialog.project.select_repo.description": "{{name}}와(과) 연결됨",
  "dialog.project.select_repo.search.placeholder": "리포지토리 검색",
  "dialog.project.select_repo.empty": "리포지토리를 찾을 수 없습니다",
  "dialog.project.select_repo.no_description": "설명 없음",
  "dialog.project.select_repo.loading": "리포지토리 로딩 중...",
  "dialog.project.select_repo.error": "리포지토리를 로드하는 중 오류가 발생했습니다. 잘못된 구성 또는 유효하지 않거나 만료된 토큰이 원인일 수 있습니다. 구성을 확인하고 다시 시도하십시오.",
  "dialog.project.select_repo.loading_more": "추가 로딩 중...",
  "dialog.project.clone.title": "리포지토리 복제 중",
  "dialog.project.clone.cloning": "{{name}} 복제 중...",
  "dialog.project.clone.branch": "브랜치: {{branch}}",
  ...
  "dialog.project.select_branch.empty": "브랜치를 찾을 수 없습니다",
  "dialog.project.select_branch.back": "리포지토리 목록으로 돌아가기",
  "dialog.project.select_branch.default": "기본 브랜치 사용 ({{branch}})",
  "dialog.project.select_branch.protected": "보호됨",
  "dialog.project.select_branch.loading": "브랜치 로딩 중...",
