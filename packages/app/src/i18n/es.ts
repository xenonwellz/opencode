export const dict = {
  ...
  "dialog.project.provider.local.description": "Abrir un directorio local",
  "dialog.project.provider.github.description": "GitHub ({{type}})",
  "dialog.project.provider.add.name": "Agregar proveedor",
  "dialog.project.provider.add.description": "Conectar un nuevo proveedor",
  "dialog.project.delete.title": "Eliminar proveedor",
  "dialog.project.delete.description": "¿Está seguro de que desea eliminar \"{{name}}\"? Esto eliminará el token de acceso de GitHub de su máquina.",
  "dialog.project.delete.success.title": "Proveedor eliminado",
  "dialog.project.delete.success.description": "\"{{name}}\" ha sido removido.",
  "dialog.project.delete.error.title": "Error al eliminar el proveedor",
  "dialog.project.open.title": "Abrir proyecto",
  "dialog.project.open.description": "Elija cómo abrir su proyecto",
  "dialog.project.search.placeholder": "Buscar proveedores",
  "dialog.project.empty": "No hay proveedores disponibles",
  "dialog.project.select_provider.title": "Seleccionar proveedor",
  "dialog.project.select_provider.description": "Elija un proveedor para conectar",
  ...
  "dialog.project.add_github.error.name_required": "El nombre es requerido",
  "dialog.project.add_github.error.token_required": "El token es requerido",
  "dialog.project.add_github.error.invalid_token": "Hubo un error con el token proporcionado. Este token puede ya no ser válido",
  "dialog.project.add_github.success.title": "Clave de GitHub agregada",
  "dialog.project.add_github.success.description": "Ahora puede usar esta clave para acceder a sus repositorios de GitHub.",
  "dialog.project.add_github.create_token": "Crear token en GitHub",
  "dialog.project.add_github.token_instruction": "Para tokens clásicos, use el scope repo. Para tokens de grano fino, conceda acceso al repositorio.",
  "dialog.project.add_github.name.label": "Nombre",
  "dialog.project.add_github.name.placeholder": "Mi Token de GitHub",
  "dialog.project.add_github.token.label": "Token de Acceso Personal",
  "dialog.project.add_github.token.placeholder": "ghp_xxxxxxxxxxxxxxxxxxxx",
  "dialog.project.add_github.button.add": "Agregar clave",
  "dialog.project.add_github.button.adding": "Agregando...",
  ...
  "dialog.project.clone.branch": "Rama: {{branch}}",
  ...
  "dialog.project.select_branch.empty": "No se encontraron ramas",
  "dialog.project.select_branch.back": "Volver a repositorios",
  "dialog.project.select_branch.default": "Usar rama predeterminada ({{branch}})",
  ...
  "home.empty.description": "Abre un proyecto local o conecta un proveedor compatible para empezar",
