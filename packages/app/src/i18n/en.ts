export const dict = {
  ...
  "dialog.project.select_repo.error":
    "There was an error loading repositories, this can be caused by incorrect configuration or invalid/expired token. Please check your configuration and try again.",
