export const dict = {
  ...
  "dialog.project.delete.description": "Are you sure you want to delete \"{{name}}\"? This will remove the GitHub access token from your machine.",
  ...
  "dialog.project.add_github.description": "Enter a name for this key and your GitHub personal access token. The token will be stored securely on your machine.",
  ...
  "dialog.project.add_github.error.invalid_token": "There was an error with the provided token, this token may no longer be valid",
  ...
  "dialog.project.add_github.token_instruction": "For classic tokens, use the repo scope. For fine-grained tokens, grant repository access.",
  ...
  "dialog.project.select_repo.empty": "No repositories found",
  "dialog.project.select_repo.no_description": "No description",
  "dialog.project.select_repo.loading": "Loading repositories...",
  "dialog.project.select_repo.error": "There was an error loading repositories, this can be caused by incorrect configuration or invalid/expired token. Please check your configuration and try again.",
  "dialog.project.select_repo.loading_more": "Loading more...",
  "dialog.project.clone.title": "Cloning repository",
  "dialog.project.clone.cloning": "Cloning {{name}}...",
  ...
  "dialog.project.select_branch.empty": "No branches found",
  "dialog.project.select_branch.back": "Back to repositories",
  "dialog.project.select_branch.default": "Use default branch ({{branch}})",
  "dialog.project.select_branch.protected": "Protected",
  "dialog.project.select_branch.loading": "Loading branches...",
