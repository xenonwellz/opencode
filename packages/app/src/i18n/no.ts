...
export const dict = {
  ...
  "dialog.project.edit.worktree.startup.description": "Kjører etter opprettelse av nytt arbeidsområde (worktree).",
  "dialog.project.edit.worktree.startup.placeholder": "f.eks. bun install",

  "dialog.project.provider.local.name": "Lokal",
  "dialog.project.provider.local.description": "Åpne en lokal mappe",
  "dialog.project.provider.github.description": "GitHub ({{type}})",
  "dialog.project.provider.add.name": "Legg til leverandør",
  "dialog.project.provider.add.description": "Koble til en ny leverandør",
  "dialog.project.delete.title": "Slett leverandør",
  "dialog.project.delete.description": "Er du sikker på at du vil slette \"{{name}}\"? Dette vil fjerne GitHub-tilgangstokenet fra maskinen din.",
  "dialog.project.delete.success.title": "Leverandør slettet",
  "dialog.project.delete.success.description": "\"{{name}}\" har blitt fjernet.",
  "dialog.project.delete.error.title": "Feil ved sletting av leverandør",
  "dialog.project.open.title": "Åpne prosjekt",
  "dialog.project.open.description": "Velg hvordan du vil åpne prosjektet ditt",
  "dialog.project.search.placeholder": "Søk leverandører",
  "dialog.project.empty": "Ingen leverandører tilgjengelig",
  "dialog.project.select_provider.title": "Velg leverandør",
  "dialog.project.select_provider.description": "Velg en leverandør å koble til",
  ...
  "dialog.project.add_github.error.name_required": "Navn er påkrevd",
  "dialog.project.add_github.error.token_required": "Token er påkrevd",
  "dialog.project.add_github.error.invalid_token": "Det oppstod en feil med den oppgitte tokenen. Denne tokenen er kanskje ikke lenger gyldig",
  "dialog.project.add_github.success.title": "GitHub-nøkkel lagt til",
  "dialog.project.add_github.success.description": "Du kan nå bruke denne nøkkelen for å få tilgang til GitHub-repositoriene dine.",
  "dialog.project.add_github.create_token": "Opprett token på GitHub",
  "dialog.project.add_github.token_instruction": "For klassiske tokens, bruk repo omfanget. For finkornede tokens, gi repository tilgang.",
  "dialog.project.add_github.name.label": "Navn",
  "dialog.project.add_github.name.placeholder": "Min GitHub Token",
  "dialog.project.add_github.token.label": "Personlig Tilgangstoken",
  "dialog.project.add_github.token.placeholder": "ghp_xxxxxxxxxxxxxxxxxxxx",
  "dialog.project.add_github.button.add": "Legg til nøkkel",
  "dialog.project.add_github.button.adding": "Legger til...",
  ...
  "dialog.project.select_branch.empty": "Ingen grener funnet",
  "dialog.project.select_branch.back": "Tilbake til repositories",
  "dialog.project.select_branch.default": "Bruk standard gren ({{branch}})",
