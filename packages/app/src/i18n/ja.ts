export const dict = {
  ...
  "dialog.project.provider.local.name": "ローカル",
  "dialog.project.provider.local.description": "ローカルディレクトリを開く",
  "dialog.project.provider.github.description": "GitHub ({{type}})",
  "dialog.project.provider.add.name": "プロバイダーを追加",
  "dialog.project.provider.add.description": "新しいプロバイダーを接続",
  "dialog.project.delete.title": "プロバイダーを削除",
  "dialog.project.delete.description": "\"{{name}}\"を削除してもよろしいですか？この操作により、マシンからGitHubアクセストークンが削除されます。",
  "dialog.project.delete.success.title": "プロバイダーが削除されました",
  "dialog.project.delete.success.description": "\"{{name}}\"が削除されました。",
  "dialog.project.delete.error.title": "プロバイダーの削除に失敗しました",
  "dialog.project.open.title": "プロジェクトを開く",
  "dialog.project.open.description": "プロジェクトを開く方法を選択してください",
  "dialog.project.search.placeholder": "プロバイダーを検索",
  "dialog.project.empty": "利用可能なプロバイダーがありません",
  "dialog.project.select_provider.title": "プロバイダーを選択",
  "dialog.project.select_provider.description": "接続するプロバイダーを選択してください",
  "dialog.project.add_github.title": "GitHubキーを追加",
  "dialog.project.add_github.description": "このキーの名前とGitHub個人アクセストークンを入力してください。トークンはマシンに安全に保存されます。",
  "dialog.project.add_github.error.name_required": "名前は必須です",
  "dialog.project.add_github.error.token_required": "トークンは必須です",
  "dialog.project.add_github.error.invalid_token": "提供されたトークンにエラーがあります。このトークンはすでに有効ではない可能性があります。",
  "dialog.project.add_github.success.title": "GitHubキーが追加されました",
  "dialog.project.add_github.success.description": "このキーを使用してGitHubリポジトリにアクセスできるようになりました。",
  "dialog.project.add_github.create_token": "GitHubでトークンを作成",
  "dialog.project.add_github.token_instruction": "クラシックトークンの場合は repo スコープを使用してください。ファイングレインドトークンの場合はリポジトリへのアクセス権を付与してください。",
  "dialog.project.add_github.name.label": "名前",
  "dialog.project.add_github.name.placeholder": "マイGitHubトークン",
  "dialog.project.add_github.token.label": "個人アクセストークン",
  "dialog.project.add_github.token.placeholder": "ghp_xxxxxxxxxxxxxxxxxxxx",
  "dialog.project.add_github.button.add": "キーを追加",
  "dialog.project.add_github.button.adding": "追加中...",
  "dialog.project.select_repo.title": "リポジトリを選択",
  "dialog.project.select_repo.description": "{{name}} で接続済み",
  "dialog.project.select_repo.search.placeholder": "リポジトリを検索",
  "dialog.project.select_repo.empty": "リポジトリが見つかりません",
  "dialog.project.select_repo.no_description": "説明なし",
  "dialog.project.select_repo.loading": "リポジトリを読み込んでいます...",
  "dialog.project.select_repo.error": "リポジトリの読み込み中にエラーが発生しました。設定が正しくないか、トークンが無効または期限切れである可能性があります。設定を確認して再試行してください。",
  "dialog.project.select_repo.loading_more": "さらに読み込んでいます...",
  "dialog.project.clone.title": "リポジトリをクローンしています",
  "dialog.project.clone.cloning": "{{name}} をクローンしています...",
  "dialog.project.clone.branch": "ブランチ: {{branch}}",
  ...
  "dialog.project.select_branch.empty": "ブランチが見つかりません",
  "dialog.project.select_branch.back": "リポジトリ一覧に戻る",
  "dialog.project.select_branch.default": "デフォルトブランチを使用 ({{branch}})",
  "dialog.project.select_branch.protected": "保護済み",
  "dialog.project.select_branch.loading": "ブランチを読み込んでいます...",
