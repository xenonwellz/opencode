export const dict = {
  ...
  "dialog.project.provider.local.description": "Abrir um diretório local",
  "dialog.project.provider.github.description": "GitHub ({{type}})",
  "dialog.project.provider.add.name": "Adicionar provedor",
  "dialog.project.provider.add.description": "Conectar um novo provedor",
  "dialog.project.delete.title": "Excluir provedor",
  "dialog.project.delete.description": "Tem certeza de que deseja excluir \"{{name}}\"? Isso removerá o token de acesso do GitHub da sua máquina.",
  "dialog.project.delete.success.title": "Provedor excluído",
  "dialog.project.delete.success.description": "\"{{name}}\" foi removido.",
  "dialog.project.delete.error.title": "Erro ao excluir o provedor",
  "dialog.project.open.title": "Abrir projeto",
  "dialog.project.open.description": "Escolha como abrir seu projeto",
  "dialog.project.search.placeholder": "Buscar provedores",
  "dialog.project.empty": "Nenhum provedor disponível",
  "dialog.project.select_provider.title": "Selecionar provedor",
  "dialog.project.select_provider.description": "Escolha um provedor para conectar",
  "dialog.project.add_github.title": "Adicionar chave do GitHub",
  "dialog.project.add_github.description": "Digite um nome para esta chave e seu token de acesso pessoal do GitHub. O token será armazenado com segurança na sua máquina.",
  "dialog.project.add_github.error.name_required": "Nome é obrigatório",
  "dialog.project.add_github.error.token_required": "Token é obrigatório",
  "dialog.project.add_github.error.invalid_token": "Houve um erro com o token fornecido. Este token pode não ser mais válido",
  "dialog.project.add_github.success.title": "Chave do GitHub adicionada",
  "dialog.project.add_github.success.description": "Agora você pode usar esta chave para acessar seus repositórios do GitHub.",
  "dialog.project.add_github.create_token": "Criar token no GitHub",
  "dialog.project.add_github.token_instruction": "Para tokens clássicos, use o escopo repo. Para tokens de granulação fina, conceda acesso ao repositório.",
  "dialog.project.add_github.name.label": "Nome",
  "dialog.project.add_github.name.placeholder": "Meu Token do GitHub",
  "dialog.project.add_github.token.label": "Token de Acesso Pessoal",
  "dialog.project.add_github.token.placeholder": "ghp_xxxxxxxxxxxxxxxxxxxx",
  "dialog.project.add_github.button.add": "Adicionar chave",
  "dialog.project.add_github.button.adding": "Adicionando...",
  "dialog.project.select_repo.title": "Selecionar repositório",
  "dialog.project.select_repo.description": "Conectado com {{name}}",
  "dialog.project.select_repo.search.placeholder": "Buscar repositórios",
  "dialog.project.select_repo.empty": "Nenhum repositório encontrado",
  "dialog.project.select_repo.no_description": "Sem descrição",
  "dialog.project.select_repo.loading": "Carregando repositórios...",
  "dialog.project.select_repo.error": "Houve um erro ao carregar os repositórios. Isso pode ser causado por configuração incorreta ou tokens inválidos/expirados. Por favor verifique sua configuração e tente novamente.",
  "dialog.project.select_repo.loading_more": "Carregar mais...",
  "dialog.project.clone.title": "Clonando repositório",
  ...
  "dialog.project.select_branch.empty": "Nenhum branch encontrado",
  "dialog.project.select_branch.back": "Voltar aos repositórios",
  ...
  "home.empty.description": "Abra um projeto local ou conecte um provedor compatível para começar",
