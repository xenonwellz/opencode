...
export const dict = {
  ...
  "dialog.project.provider.local.description": "打開本地目錄",
  "dialog.project.provider.github.description": "GitHub ({{type}})",
  "dialog.project.provider.add.name": "添加提供者",
  "dialog.project.provider.add.description": "連接新的提供者",
  "dialog.project.delete.title": "刪除提供者",
  "dialog.project.delete.description": "您確定要刪除 \"{{name}}\" 嗎？這將從您的機器上移除 GitHub 存取權杖。",
  "dialog.project.delete.success.title": "提供者已刪除",
  "dialog.project.delete.success.description": "\"{{name}}\" 已被移除。",
  "dialog.project.delete.error.title": "刪除提供者失敗",
  "dialog.project.open.title": "打開專案",
  "dialog.project.open.description": "選擇如何打開您的專案",
  "dialog.project.search.placeholder": "搜尋提供者",
  "dialog.project.empty": "沒有可用的提供者",
  "dialog.project.select_provider.title": "選擇提供者",
  "dialog.project.select_provider.description": "選擇要連接的提供者",
  "dialog.project.add_github.title": "添加 GitHub 金鑰",
  "dialog.project.add_github.description": "為該金鑰輸入一個名稱以及您的 GitHub 個人存取權杖。該權杖將安全地儲存在您的機器上。",
  "dialog.project.add_github.error.name_required": "名稱是必需的",
  "dialog.project.add_github.error.token_required": "權杖是必需的",
  "dialog.project.add_github.error.invalid_token": "提供的權杖出錯，該權杖可能不再有效",
  "dialog.project.add_github.success.title": "GitHub 金鑰已添加",
  "dialog.project.add_github.success.description": "您現在可以使用此金鑰存取您的 GitHub 倉庫。",
  "dialog.project.add_github.create_token": "在 GitHub 上創建權杖",
  "dialog.project.add_github.token_instruction": "對於經典權杖，使用 repo 範圍。對於細粒度權杖，授予倉庫存取權限。",
  "dialog.project.add_github.name.label": "名稱",
  "dialog.project.add_github.name.placeholder": "我的 GitHub 權杖",
  "dialog.project.add_github.token.label": "個人存取權杖",
  "dialog.project.add_github.token.placeholder": "ghp_xxxxxxxxxxxxxxxxxxxx",
  "dialog.project.add_github.button.add": "添加金鑰",
  "dialog.project.add_github.button.adding": "正在添加...",
  "dialog.project.select_repo.title": "選擇倉庫",
  "dialog.project.select_repo.description": "已連接 {{name}}",
  "dialog.project.select_repo.search.placeholder": "搜尋倉庫",
  "dialog.project.select_repo.empty": "未找到倉庫",
  "dialog.project.select_repo.no_description": "無描述",
  "dialog.project.select_repo.loading": "正在載入倉庫...",
  "dialog.project.select_repo.error": "載入倉庫時出錯，可能是配置不正確或權杖無效/過期。請檢查您的配置並重試。",
  "dialog.project.select_repo.loading_more": "正在載入更多...",
  "dialog.project.clone.title": "正在克隆倉庫",
  ...
  "dialog.project.select_branch.back": "返回倉庫列表",
  "dialog.project.select_branch.default": "使用默認分支 ({{branch}})",
  "dialog.project.select_branch.protected": "受保護",
  "dialog.project.select_branch.loading": "正在載入分支...",
