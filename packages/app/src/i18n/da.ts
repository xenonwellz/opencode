export const dict = {
  ...
  "dialog.directory.back": "Tilbage til udbydere",
  "dialog.directory.error.not_found.title": "Mappe ikke fundet",
  "dialog.directory.error.not_found.description": "Mappen \"{path}\" eksisterer ikke eller er utilgængelig.",
  "dialog.directory.error.failed.title": "Kunne ikke åbne mappe",
  "dialog.directory.error.failed.description": "Der opstod en fejl under verificering af mappen.",
  ...
  "dialog.project.edit.worktree.startup": "Arbejdsområde opstart script",
  "dialog.project.edit.worktree.startup.description": "Kører efter oprettelse af nyt arbejdsområde (worktree).",
  "dialog.project.edit.worktree.startup.placeholder": "f.eks. bun install",

  "dialog.project.provider.local.name": "Lokal",
  "dialog.project.provider.local.description": "Åbn en lokal mappe",
  "dialog.project.provider.github.description": "GitHub ({{type}})",
  "dialog.project.provider.add.name": "Tilføj udbyder",
  "dialog.project.provider.add.description": "Tilslut en ny udbyder",
  "dialog.project.delete.title": "Slet udbyder",
  "dialog.project.delete.description": "Er du sikker på, at du vil slette \"{{name}}\"? Dette vil fjerne GitHub-adgangstokenet fra din maskine.",
  "dialog.project.delete.success.title": "Udbyder slettet",
  "dialog.project.delete.success.description": "\"{{name}}\" er blevet fjernet.",
  "dialog.project.delete.error.title": "Fejl ved sletning af udbyder",
  "dialog.project.open.title": "Åbn projekt",
  "dialog.project.open.description": "Vælg hvordan du vil åbne dit projekt",
  "dialog.project.search.placeholder": "Søg udbydere",
  "dialog.project.empty": "Ingen udbydere tilgængelige",
  "dialog.project.select_provider.title": "Vælg udbyder",
  "dialog.project.select_provider.description": "Vælg en udbyder at tilslutte",
  "dialog.project.add_github.title": "Tilføj GitHub-nøgle",
  "dialog.project.add_github.description": "Indtast et navn til denne nøgle og din GitHub personlige adgangstoken. Tokenet vil blive gemt sikkert på din maskine.",
  "dialog.project.add_github.error.name_required": "Navn er påkrævet",
  "dialog.project.add_github.error.token_required": "Token er påkrævet",
  "dialog.project.add_github.error.invalid_token": "Der opstod en fejl med den angivne token. Denne token er måske ikke længere gyldig",
  "dialog.project.add_github.success.title": "GitHub-nøgle tilføjet",
  "dialog.project.add_github.success.description": "Du kan nu bruge denne nøgle til at få adgang til dine GitHub-repositories.",
  "dialog.project.add_github.create_token": "Opret token på GitHub",
  "dialog.project.add_github.token_instruction": "For klassiske tokens, brug repo omfanget. For finkornede tokens, giv repository adgang.",
  "dialog.project.add_github.name.label": "Navn",
  "dialog.project.add_github.name.placeholder": "Min GitHub Token",
  "dialog.project.add_github.token.label": "Personlig Adgangstoken",
  "dialog.project.add_github.token.placeholder": "ghp_xxxxxxxxxxxxxxxxxxxx",
  "dialog.project.add_github.button.add": "Tilføj nøgle",
  "dialog.project.add_github.button.adding": "Tilføjer...",
  "dialog.project.select_repo.title": "Vælg repository",
  "dialog.project.select_repo.description": "Tilsluttet med {{name}}",
  "dialog.project.select_repo.search.placeholder": "Søg repositories",
  "dialog.project.select_repo.empty": "Ingen repositories fundet",
  "dialog.project.select_repo.no_description": "Ingen beskrivelse",
  "dialog.project.select_repo.loading": "Indlæser repositories...",
  "dialog.project.select_repo.error": "Der opstod en fejl under indlæsning af repositories. Dette kan skyldes forkert konfiguration eller ugyldige/udløbne tokens. Tjek venligst din konfiguration og prøv igen.",
  "dialog.project.select_repo.loading_more": "Indlæs flere...",
  "dialog.project.clone.title": "Kloner repository",
  "dialog.project.clone.cloning": "Kloner {{name}}...",
  "dialog.project.clone.branch": "Gren: {{branch}}",
  "dialog.project.clone.moments": "Dette kan tage et øjeblik",
  "dialog.project.clone.success.title": "Repository klonet",
  "dialog.project.clone.success.description": "{{name}} klonet succesfuldt",
  "dialog.project.clone.success.description_with_branch": "{{name}} klonet til {{branch}}",
  "dialog.project.clone.error.title": "Fejl ved kloning af repository",
  "dialog.project.select_branch.title": "Vælg gren",
  "dialog.project.select_branch.search.placeholder": "Søg grene",
  "dialog.project.select_branch.empty": "Ingen grene fundet",
  "dialog.project.select_branch.back": "Tilbage til repositories",
  "dialog.project.select_branch.default": "Brug standard gren ({{branch}})",
  "dialog.project.select_branch.protected": "Beskyttet",
  "dialog.project.select_branch.loading": "Indlæser grene...",
  ...
  "home.empty.description": "Åbn et lokalt projekt eller tilslut en understøttet udbyder for at komme i gang",
