...
export const dict = {
  ...
  "dialog.project.provider.local.name": "本地",
  "dialog.project.provider.local.description": "打开本地目录",
  "dialog.project.provider.github.description": "GitHub ({{type}})",
  "dialog.project.provider.add.name": "添加提供商",
  "dialog.project.provider.add.description": "连接新的提供商",
  "dialog.project.delete.title": "删除提供商",
  "dialog.project.delete.description": "您确定要删除 \"{{name}}\" 吗？这将从您的机器上移除 GitHub 访问令牌。",
  "dialog.project.delete.success.title": "提供商已删除",
  "dialog.project.delete.success.description": "\"{{name}}\" 已被移除。",
  "dialog.project.delete.error.title": "删除提供商失败",
  "dialog.project.open.title": "打开项目",
  "dialog.project.open.description": "选择如何打开您的项目",
  "dialog.project.search.placeholder": "搜索提供商",
  "dialog.project.empty": "没有可用的提供商",
  "dialog.project.select_provider.title": "选择提供商",
  "dialog.project.select_provider.description": "选择要连接的提供商",
  "dialog.project.add_github.title": "添加 GitHub 密钥",
  "dialog.project.add_github.description": "为该密钥输入一个名称以及您的 GitHub 个人访问令牌。该令牌将安全地存储在您的机器上。",
  "dialog.project.add_github.error.name_required": "名称是必需的",
  "dialog.project.add_github.error.token_required": "令牌是必需的",
  "dialog.project.add_github.error.invalid_token": "提供的令牌出错，该令牌可能不再有效",
  "dialog.project.add_github.success.title": "GitHub 密钥已添加",
  "dialog.project.add_github.success.description": "您现在可以使用此密钥访问您的 GitHub 仓库。",
  "dialog.project.add_github.create_token": "在 GitHub 上创建令牌",
  "dialog.project.add_github.token_instruction": "对于经典令牌，使用 repo 范围。对于细粒度令牌，授予仓库访问权限。",
  "dialog.project.add_github.name.label": "名称",
  "dialog.project.add_github.name.placeholder": "我的 GitHub 令牌",
  "dialog.project.add_github.token.label": "个人访问令牌",
  "dialog.project.add_github.token.placeholder": "ghp_xxxxxxxxxxxxxxxxxxxx",
  "dialog.project.add_github.button.add": "添加密钥",
  "dialog.project.add_github.button.adding": "正在添加...",
  "dialog.project.select_repo.title": "选择仓库",
  "dialog.project.select_repo.description": "已连接 {{name}}",
  "dialog.project.select_repo.search.placeholder": "搜索仓库",
  "dialog.project.select_repo.empty": "未找到仓库",
  "dialog.project.select_repo.no_description": "无描述",
  "dialog.project.select_repo.loading": "正在加载仓库...",
  "dialog.project.select_repo.error": "加载仓库时出错，可能是配置不正确或令牌无效/过期。请检查您的配置并重试。",
  "dialog.project.select_repo.loading_more": "正在加载更多...",
  "dialog.project.clone.title": "正在克隆仓库",
  "dialog.project.clone.cloning": "正在克隆 {{name}}...",
  "dialog.project.clone.branch": "分支: {{branch}}",
  ...
  "dialog.project.select_branch.empty": "未找到分支",
  "dialog.project.select_branch.back": "返回仓库列表",
  "dialog.project.select_branch.default": "使用默认分支 ({{branch}})",
  "dialog.project.select_branch.protected": "受保护",
  "dialog.project.select_branch.loading": "正在加载分支...",
  ...
  "home.empty.description": "打开本地项目或连接支持的服务商以开始使用",
