export const dict = {
  ...
  "dialog.project.provider.local.description": "Ouvrir un répertoire local",
  "dialog.project.provider.github.description": "GitHub ({{type}})",
  "dialog.project.provider.add.name": "Ajouter un fournisseur",
  "dialog.project.provider.add.description": "Connecter un nouveau fournisseur",
  "dialog.project.delete.title": "Supprimer le fournisseur",
  "dialog.project.delete.description": "Êtes-vous sûr de vouloir supprimer \"{{name}}\" ? Cela supprimera le jeton d'accès GitHub de votre machine.",
  "dialog.project.delete.success.title": "Fournisseur supprimé",
  "dialog.project.delete.success.description": "\"{{name}}\" a été supprimé.",
  "dialog.project.delete.error.title": "Erreur lors de la suppression du fournisseur",
  "dialog.project.open.title": "Ouvrir un projet",
  "dialog.project.open.description": "Choisissez comment ouvrir votre projet",
  "dialog.project.search.placeholder": "Rechercher des fournisseurs",
  "dialog.project.empty": "Aucun fournisseur disponible",
  "dialog.project.select_provider.title": "Sélectionner un fournisseur",
  "dialog.project.select_provider.description": "Choisissez un fournisseur à connecter",
  ...
  "dialog.project.add_github.error.name_required": "Le nom est requis",
  "dialog.project.add_github.error.token_required": "Le jeton est requis",
  "dialog.project.add_github.error.invalid_token": "Il y a eu une erreur avec le jeton fourni. Ce jeton n'est peut-être plus valide",
  "dialog.project.add_github.success.title": "Clé GitHub ajoutée",
  "dialog.project.add_github.success.description": "Vous pouvez maintenant utiliser cette clé pour accéder à vos dépôts GitHub.",
  "dialog.project.add_github.create_token": "Créer un jeton sur GitHub",
  "dialog.project.add_github.token_instruction": "Pour les jetons classiques, utilisez le scope repo. Pour les jetons à grain fin, accordez l'accès au dépôt.",
  "dialog.project.add_github.name.label": "Nom",
  "dialog.project.add_github.name.placeholder": "Mon Jeton GitHub",
  "dialog.project.add_github.token.label": "Jeton d'Accès Personnel",
  "dialog.project.add_github.token.placeholder": "ghp_xxxxxxxxxxxxxxxxxxxx",
  "dialog.project.add_github.button.add": "Ajouter la clé",
  "dialog.project.add_github.button.adding": "Ajout...",
  ...
  "dialog.project.clone.branch": "Branche : {{branch}}",
  ...
  "dialog.project.select_branch.empty": "Aucune branche trouvée",
  "dialog.project.select_branch.back": "Retour aux dépôts",
  "dialog.project.select_branch.default": "Utiliser la branche par défaut ({{branch}})",
  ...
  "home.empty.description": "Ouvrez un projet local ou connectez un fournisseur pris en charge pour commencer",
