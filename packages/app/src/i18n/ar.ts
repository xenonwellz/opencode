export const dict = {
  ...
  "dialog.project.edit.worktree.startup": "سكريبت بدء مساحة العمل",
  "dialog.project.edit.worktree.startup.description": "يعمل بعد إنشاء مساحة عمل جديدة (worktree).",
  "dialog.project.edit.worktree.startup.placeholder": "مثال: bun install",

  "dialog.project.provider.local.name": "محلي",
  "dialog.project.provider.local.description": "افتح مجلد محلي",
  "dialog.project.provider.github.description": "GitHub ({{type}})",
  "dialog.project.provider.add.name": "إضافة مزود",
  "dialog.project.provider.add.description": "ربط مزود جديد",
  "dialog.project.delete.title": "حذف المزود",
  "dialog.project.delete.description": "هل أنت متأكد من أنك تريد حذف \"{{name}}\"؟ سيؤدي هذا إلى إزالة رمز الوصول إلى GitHub من جهازك.",
  "dialog.project.delete.success.title": "تم حذف المزود",
  "dialog.project.delete.success.description": "تم إزالة \"{{name}}\".",
  "dialog.project.delete.error.title": "خطأ في حذف المزود",
  "dialog.project.open.title": "فتح المشروع",
  "dialog.project.open.description": "اختر كيفية فتح مشروعك",
  "dialog.project.search.placeholder": "البحث عن المزودين",
  "dialog.project.empty": "لا يوجد مزودون متاحون",
  "dialog.project.select_provider.title": "اختيار المزود",
  "dialog.project.select_provider.description": "اختر مزود للربط",
  "dialog.project.add_github.title": "إضافة مفتاح GitHub",
  "dialog.project.add_github.description": "أدخل اسماً لهذا المفتاح ورمز الوصول الشخصي الخاص بك على GitHub. سيتم تخزين الرمز بشكل آمن على جهازك.",
  "dialog.project.add_github.error.name_required": "الاسم مطلوب",
  "dialog.project.add_github.error.token_required": "الرمز مطلوب",
  "dialog.project.add_github.error.invalid_token": "حدث خطأ مع الرمز المقدم. قد لا يكون هذا الرمز صالحاً بعد الآن",
  "dialog.project.add_github.success.title": "تم إضافة مفتاح GitHub",
  "dialog.project.add_github.success.description": "يمكنك الآن استخدام هذا المفتاح للوصول إلى مستودعات GitHub الخاصة بك.",
  "dialog.project.add_github.create_token": "إنشاء رمز على GitHub",
  "dialog.project.add_github.token_instruction": "للرموز الكلاسيكية، استخدم نطاق repo. للرموز ذات الحبيبات الدقيقة، امنح وصول المستودع.",
  "dialog.project.add_github.name.label": "الاسم",
  "dialog.project.add_github.name.placeholder": "رمز GitHub الخاص بي",
  "dialog.project.add_github.token.label": "رمز الوصول الشخصي",
  "dialog.project.add_github.token.placeholder": "ghp_xxxxxxxxxxxxxxxxxxxx",
  "dialog.project.add_github.button.add": "إضافة المفتاح",
  "dialog.project.add_github.button.adding": "جاري الإضافة...",
  "dialog.project.select_repo.title": "اختيار المستودع",
  "dialog.project.select_repo.description": "متصل بـ {{name}}",
  "dialog.project.select_repo.search.placeholder": "البحث عن المستودعات",
  "dialog.project.select_repo.empty": "لم يتم العثور على مستودعات",
  "dialog.project.select_repo.no_description": "لا يوجد وصف",
  "dialog.project.select_repo.loading": "جاري تحميل المستودعات...",
  "dialog.project.select_repo.error": "حدث خطأ أثناء تحميل المستودعات. قد يكون هذا بسبب تكوين خاطئ أو رموز غير صالحة/منتهية الصلاحية. يرجى التحقق من التكوين الخاص بك وحاول مرة أخرى.",
  "dialog.project.select_repo.loading_more": "تحميل المزيد...",
  "dialog.project.clone.title": "استنساخ المستودع",
  "dialog.project.clone.cloning": "استنساخ {{name}}...",
  "dialog.project.clone.branch": "الفرع: {{branch}}",
  ...
  "dialog.project.select_branch.empty": "لم يتم العثور على فروع",
  "dialog.project.select_branch.back": "العودة إلى المستودعات",
  "dialog.project.select_branch.default": "استخدام الفرع الافتراضي ({{branch}})",
  "dialog.project.select_branch.protected": "محمي",
  "dialog.project.select_branch.loading": "جاري تحميل الفروع...",
