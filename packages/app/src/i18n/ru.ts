export const dict = {
  ...
  "dialog.project.provider.local.description": "Открыть локальный каталог",
  "dialog.project.provider.github.description": "GitHub ({{type}})",
  "dialog.project.provider.add.name": "Добавить провайдера",
  "dialog.project.provider.add.description": "Подключить нового провайдера",
  "dialog.project.delete.title": "Удалить провайдера",
  "dialog.project.delete.description": "Вы уверены, что хотите удалить \"{{name}}\"? Это удалит токен доступа GitHub с вашего компьютера.",
  "dialog.project.delete.success.title": "Провайдер удален",
  "dialog.project.delete.success.description": "\"{{name}}\" был удален.",
  "dialog.project.delete.error.title": "Ошибка удаления провайдера",
  "dialog.project.open.title": "Открыть проект",
  "dialog.project.open.description": "Выберите, как открыть ваш проект",
  "dialog.project.search.placeholder": "Поиск провайдеров",
  "dialog.project.empty": "Нет доступных провайдеров",
  "dialog.project.select_provider.title": "Выбрать провайдера",
  "dialog.project.select_provider.description": "Выберите провайдера для подключения",
  ...
  "dialog.project.add_github.error.name_required": "Имя обязательно",
  "dialog.project.add_github.error.token_required": "Токен обязателен",
  "dialog.project.add_github.error.invalid_token": "Произошла ошибка с предоставленным токеном. Этот токен может быть больше недействительным",
  "dialog.project.add_github.success.title": "Ключ GitHub добавлен",
  "dialog.project.add_github.success.description": "Теперь вы можете использовать этот ключ для доступа к вашим репозиториям GitHub.",
  "dialog.project.add_github.create_token": "Создать токен на GitHub",
  "dialog.project.add_github.token_instruction": "Для классических токенов используйте scope repo. Для токенов с тонкой настройкой предоставьте доступ к репозиторию.",
  "dialog.project.add_github.name.label": "Имя",
  "dialog.project.add_github.name.placeholder": "Мой токен GitHub",
  "dialog.project.add_github.token.label": "Персональный токен доступа",
  "dialog.project.add_github.token.placeholder": "ghp_xxxxxxxxxxxxxxxxxxxx",
  "dialog.project.add_github.button.add": "Добавить ключ",
  "dialog.project.add_github.button.adding": "Добавление...",
  ...
  "dialog.project.clone.branch": "Ветка: {{branch}}",
  ...
  "dialog.project.select_branch.empty": "Ветки не найдены",
  "dialog.project.select_branch.back": "Назад к репозиториям",
  "dialog.project.select_branch.default": "Использовать ветку по умолчанию ({{branch}})",
